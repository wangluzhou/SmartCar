...
names = ['None', 'User.1', 'User.2', 'Ilza', 'Z', 'W']
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        # Check if distance is less them 100 ==> "0" is perfect match 
        ...
        cv2.putText(img, 'distance'+str(int(distance)), (x+5, y+h+22), font, 1, (255,255,255), 2)
